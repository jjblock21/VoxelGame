...
namespace VoxelGame.Engine
{
    ...
    public class SimplexNoise
    {
        ...
        {
            if (perm.Length != 512)
                throw new ArgumentException("Permutation table needs contain 512 values!");
            _perm = perm;
        }
        ...
        /*/// <summary>
        /// Switches the permutation table used for generating the noise with the original table.
        /// </summary>
        public void UseOriginalPermTable()
        {
